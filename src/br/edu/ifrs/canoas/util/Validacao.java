 ...
 */
package br.edu.ifrs.canoas.util;
...
public class Validacao {
    ...
    public static boolean validarNome(String c) {
        return c.matches("^[A-zÀ-ú]{2,20}([ ][A-zÀ-ú]{2,20}){0,5}$");
    }

    public static boolean validarEmail(String c) {
        return c.matches("^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$");
    }
